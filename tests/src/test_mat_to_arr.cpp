...
void bind_test_mat_to_arr_return(py::module& m) {
    m.def("mat_to_arr_return", &carma::tests::test_mat_to_arr_return, "Test mat_to_arr");
}

void bind_test_row_to_arr_return(py::module& m) {
    m.def("row_to_arr_return", &carma::tests::test_row_to_arr_return, "Test row_to_arr");
}

void bind_test_col_to_arr_return(py::module& m) {
    m.def("col_to_arr_return", &carma::tests::test_col_to_arr_return, "Test col_to_arr");
}

void bind_test_cube_to_arr_return(py::module& m) {
    m.def("cube_to_arr_return", &carma::tests::test_cube_to_arr_return, "Test cube_to_arr");
}
...
void bind_test_row_to_arr(py::module& m) {
    m.def("row_to_arr", &carma::tests::test_row_to_arr, "Test row_to_arr");
}
